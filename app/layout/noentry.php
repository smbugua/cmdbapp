			...
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						...
						<span class="brand-text">CMDB</span>
					</a>
				</div>
				<div class="form-group mb-0 pull-right">
					<a class="inline-block btn btn-success btn-rounded btn-outline nonecase-font" href="../admin/">Back to Home</a>
				</div>
